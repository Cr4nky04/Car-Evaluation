...
def main():    
    ...
    bagging_processed_feature = processing("bagging_processing.pkl",input_feature)
    Ankun_processed_feature = processing("Ankun_processing.pkl",input_feature)
    knn_processed_feature = processing("knn_process_data.pkl",input_feature)
    svr_processed_feature = processing("process_data.pkl", input_feature)
    pr_processed_feature = processing("poly_regress_processor.pkl", input_feature)
    stack_processed_feature = processing("stack_processing.pkl",input_feature)
    cluster_processed_feature = processing("similar_process_data.pkl", input_feature)
    
    
    svr_model = jl.load("best_model.joblib")
    rf_model = jl.load("rf_model.joblib")
    dt_model = jl.load("dt_model.joblib")
    knn_model = jl.load("knn_model.joblib")
    bagging_model = jl.load("bagging_model.joblib")
    ab_model = jl.load("AdaBoost_model.joblib")
    gb_model = jl.load("gb_model.joblib")
    xgb_model = jl.load("XGBoost_model.joblib")
    pr_model = jl.load("pr_model.joblib")
    stack_model = jl.load("stack_model.joblib")
    similar_car_model = jl.load("similar_car.joblib")
